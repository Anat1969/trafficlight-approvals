    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          "green-border": "hsl(var(--status-green-border))",
          yellow: "hsl(var(--status-yellow))",
          "yellow-bg": "hsl(var(--status-yellow-bg))",
          "yellow-border": "hsl(var(--status-yellow-border))",
          red: "hsl(var(--status-red))",
          "red-bg": "hsl(var(--status-red-bg))",
          "red-border": "hsl(var(--status-red-border))",
          blue: "hsl(var(--status-blue))",
          "blue-bg": "hsl(var(--status-blue-bg))",
          "blue-border": "hsl(var(--status-blue-border))",
        },
        success: {
